...
nw_list = [10, 10, 10] # 10, 10, 10
ns_list = [12, 10, 8] # 12, 10, 8
r_list = [29, 22, 32] # 29, 22, 32
per_list = [120, 115, 140] # 120, 115, 140
for r, ns, nw, per in zip(r_list, ns_list, nw_list, per_list):
    ...
    for i in tqdm(range(1, 11)):
        ...
        base_path = "experiments/warehouse/n_warehouses/diversity_sets/cco_randomseed_"+str(seed)+"_ns"+str(ns)+"_nw"+str(nw)+"_r"+str(r)+"_k"+str(k)+"_per"+str(per)+"_"
